...
if(playerAxe.isTouching(computer)&&keyDown("space")&&frameCount%3===0&&flag==="axe"){
  computerScore--;
}
if(playerTrident.isTouching(computer)&&frameCount%35===0&&flag==="trident"){
  computerScore--;
}
